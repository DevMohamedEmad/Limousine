...
<body>
    <img src="{{asset('./imgs/airport2.jpg')}}" alt="">
    <!-- <video poster="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/overlay.jpg" id="bgvid" playsinline autoplay muted loop> -->
      ...
      <a href="https://book.mylimobiz.com" data-ores-widget="website" data-ores-alias="brightempire">Online  Reservation</a>
      </div>
</body>
<script src="../js/bootstrap.bundle.min.js"></script>
<script src="https://book.mylimobiz.com" type="text/javascript"></script>
</html>