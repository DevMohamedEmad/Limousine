            ...
            <div class="row">
                  ...
                  <div class="col-md-8 col-12  row">
                        <div class="car_big-img col-12 mb-2 ">
                              <img src="{{ asset($category->cars[0]->photos[0]->photo) }}" alt="" srcset="" class=" car_img h-100 w-100" id="big_img">
                  ...
                  <div class="col-md-4 col-12 pe-2 ">
                        ...
                        <div class="rigt_content  py-5 px-1">
                              ...
                              <ul class="right_list pt-3">
                                    <li class="py-2"> <i class="fa-solid fa-person me-2 "></i><span>{{ $category->features[0]->feature }}</span> </li>
                                    @foreach ($category->features as $feature)
                                    <li class="p-2"><i class="fa-solid fa-person-walking-luggage me-2 "></i><span>{{ $feature->feature  }}</span> </li>
                                    @endforeach
                              </ul>
